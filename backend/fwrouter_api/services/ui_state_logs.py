...
UI_OPERATIONAL_EVENT_MESSAGES = {
    ...
    "xray_client_created": {"ru": "Внешний клиент создан", "en": "External client created"},
    "xray_client_create_failed": {"ru": "Не удалось создать внешнего клиента", "en": "Failed to create external client"},
    ...
    "xray_client_alias_update_failed": {
        ...
        "en": "Failed to update external client alias",
    },
    "xray_reloaded": {"ru": "Xray runtime перезагружен", "en": "Xray runtime reloaded"},
    "xray_subjects_synced": {"ru": "Внешние клиенты синхронизированы", "en": "External clients synced"},
    "xray_subjects_sync_failed": {
        "ru": "Не удалось синхронизировать внешних клиентов",
        "en": "Failed to sync external clients",
    },
    "xray_binding_materialization_failed": {
        "ru": "Не удалось подготовить runtime bindings внешних клиентов",
        "en": "Failed to prepare external client runtime bindings",
    },
...
UI_EVENT_REASONS = {
    "xray_client_create_blocked": {
        "ru": "Реализация внешних клиентов сейчас недоступна для управляемого создания клиента.",
        "en": "The external-client implementation is currently unavailable for managed client creation.",
    },
    "xray_client_create_failed": {
        "ru": "Backend не смог применить конфигурацию внешнего клиента или перезагрузить runtime.",
        "en": "The backend could not apply the external client configuration or reload the runtime.",
    },
    ...
    "xray_client_alias_update_failed": {
        ...
        "en": "The backend could not save the new external client alias.",
    },
    "xray_subjects_sync_failed": {
        "ru": "Синхронизация локального списка внешних клиентов завершилась ошибкой.",
        "en": "Local external client inventory synchronization failed.",
    },
    "xray_binding_materialization_failed": {
        "ru": "Не удалось подготовить runtime bindings между реализацией внешних клиентов и маршрутизацией FWRouter.",
        "en": "Runtime bindings between the external-client implementation and FWRouter routing could not be prepared.",
    },
    "xray_service_error": {
...
def summarize_ui_log_events(
    ...
    *,
    ...
    return [_summarize_log_event(event, technical=technical, locale=locale) for event in events]
