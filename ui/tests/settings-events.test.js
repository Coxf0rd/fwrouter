...
assert.match(indexHtml, /fwrouter-i18n\.js\?v=20260906d/);
assert.match(indexHtml, /fwrouter-labels\.js\?v=20260905b/);
assert.match(indexHtml, /fwrouter-settings-inventory\.js\?v=20260906e/);
...
assert.match(indexHtml, /settings\.js\?v=20260906e/);
