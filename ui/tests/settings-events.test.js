...
assert.match(indexHtml, /fwrouter-i18n\.js\?v=20260906e/);
...
assert.doesNotMatch(settingsJs, /fwrouter\.settings\.vpnSubscriptionUrls/);
assert.doesNotMatch(settingsJs, /function getStoredVpnSubscriptionUrls\(\)/);
assert.doesNotMatch(settingsJs, /function setStoredVpnSubscriptionUrls\(urls\)/);
...
assert.doesNotMatch(settingsJs, /setStoredVpnSubscriptionUrls\(urls\);/);
