...
Read these files first when you need to understand the project quickly:
...
- database and persistent intent: `/opt/fwrouter-api/fwrouter_api/db/schema.sql`, `/var/lib/fwrouter-v2/fwrouter.db`, [DATABASE_SCHEMA.md](/knowledge/PROJECT_MAP/DATABASE_SCHEMA.md)
...
- when code or config changes, update the affected files in `knowledge/`
- do not rewrite the full project map without a specific reason
