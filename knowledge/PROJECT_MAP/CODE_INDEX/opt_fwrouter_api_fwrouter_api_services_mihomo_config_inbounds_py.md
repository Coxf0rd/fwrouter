...
- During a subscription candidate it merges applied last-good Xray handoff
  listeners with current bindings. This keeps the existing Xray config's
  downstream SOCKS targets available until new bindings converge.
