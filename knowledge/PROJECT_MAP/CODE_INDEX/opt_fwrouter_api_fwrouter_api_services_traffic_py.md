...
- External samples may declare `metadata.external_system_id`; the backend resolves it against the persistent `external_connections` registry, enriches metadata with label/type/runtime, and rejects unknown records.
