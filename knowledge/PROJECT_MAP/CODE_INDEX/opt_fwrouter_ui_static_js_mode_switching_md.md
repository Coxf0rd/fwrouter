...
- Settings `Connections` rows are compact cards; detailed fields, settings JSON, and contract JSON open in a modal detail view on click/Enter/Space. Visibility/delete/copy buttons must not trigger row details.
