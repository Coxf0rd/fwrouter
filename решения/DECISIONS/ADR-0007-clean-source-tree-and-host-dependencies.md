...
- `решения/` хранит только актуальную knowledge map: overview docs, ADR и `CODE_INDEX`. Исторические logs, backup indexes, prompt drafts и устаревшие requirements drafts удаляются, если уже перенесены в канонические документы.
